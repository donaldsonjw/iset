...
;(define s (list->iset '(3 5 7 9)))
(define s (make-iset 3 7))
(let ((c (iset-cursor s)))
   (test "cursor1" (iset-ref s c) 3)
   (iset-cursor-next s c)
   (test "cursor2" (iset-ref s c) 4)
   (iset-cursor-next s c)
   (test "cursor3" (iset-ref s c) 5)
   (iset-cursor-next s c)
   (test "cursor4" (iset-ref s c) 6)
   (iset-cursor-next s c)
   (test "cursor5" (iset-ref s c) 7)
   (iset-cursor-next s c)
   (test "cursor6" (end-of-iset? c) #t))
